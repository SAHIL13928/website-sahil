    ...
    <section className="py-16">
      <div className="container mx-auto px-4 lg:px-24">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold overflow-hidden">OUR WORK</h2>
          <p className="text-gray-600 mt-2">
            We understand the needs for professionalism, privacy, and confidentiality. We treat all our clients with understanding, with our guidance as well as to your clients.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-8">
          ...
          <div className="flex flex-col md:flex-row items-stretch">
            ...
            />
            <div className="bg-white p-6 flex flex-col justify-center w-full md:w-1/2">
              <h3 className="text-xl font-bold">Corporate CA Firm</h3>
